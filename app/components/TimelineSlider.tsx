    ...
    >
      ...
      <div
        ...
        style={{
          ...
          rotate: "45deg",
          boxShadow: "0 0 6px 2px color-mix(in srgb, var(--color-danger) 50%, transparent)",
        }}
      />
      <div
        className="absolute pointer-events-none z-10"
        style={{
          ...
          background: "linear-gradient(to bottom, var(--color-danger), color-mix(in srgb, var(--color-danger) 30%, transparent))",
          boxShadow: "0 0 4px 1px color-mix(in srgb, var(--color-danger) 35%, transparent)",
        }}
      />
    </div>
  );
