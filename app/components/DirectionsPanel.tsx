  ...
  return (
    <div className={`flex flex-col gap-3 px-3 pb-3 ${showForm ? "pt-3" : "pt-0"}`}>
      ...
      {rainMode && onRainIntensityChange && (
        <label className="flex items-center gap-2 self-start text-[11px]" style={{ color: "var(--color-ink-muted)" }}>
          <input
            type="range"
            min={0}
            max={10}
      ...
      <div className="border-t pt-2" style={{ borderColor: "var(--color-hairline)" }}>
        ...
        <div className="flex justify-between mt-1">
          ...
          <span className="text-[11px]" style={{ color: "var(--color-ink-muted)" }}>Most shadowed</span>
        </div>
      </div>
